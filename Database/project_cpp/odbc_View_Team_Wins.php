<html>
<body>
<h3>Enter the team you would like to view for:</h3>

<form action="odbc_View_Team_Wins.php" method="post">
...
if (isset($_POST['submit'])) 
{
    ...
    $command = '/home/jrnolasc/public_html/project_cpp/odbc_View_Team_Wins.exe ' . $TeamName;
